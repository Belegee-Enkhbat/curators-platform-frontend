    ...
    return (
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <h1 className="text-4xl font-extrabold text-gray-900 mb-8 flex items-center">
                ...
                AI Контент Аналитик Туслах
            </h1>
            <p className="text-gray-600 mb-8">
                Таны оруулсан видео эсвэл нийгмийн сүлжээний линк дээр гүнзгий дүн шинжилгээ, түүний дотор өгөөжийн (Roast) үнэлгээг хийнэ.
            </p>
                ...
                <div className="space-y-10">
                    <div className="bg-white p-8 rounded-xl shadow-2xl border border-red-200">
                        <h2 className="text-3xl font-extrabold text-red-700 mb-4 flex items-center">
                            ...
                            AI Контентын Өгөөжийн Үнэлгээ (Roast)
                        </h2>
                    ...
                    <div className="grid lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-1 space-y-4">
                            <h3 className="text-xl font-bold text-indigo-700 border-b pb-2 mb-4">Үндсэн Үзүүлэлтүүд</h3>
                            {[
                                { icon: Eye, label: 'Нийт Үзэлт', value: analysisResult.keyMetrics.totalViews, color: 'text-indigo-500' },
                                { icon: Clock, label: 'Дундаж Үзсэн Хугацаа', value: analysisResult.keyMetrics.avgWatchTime, color: 'text-green-500' },
                                { icon: Heart, label: 'Хадгалсан Хэрэглэгч', value: analysisResult.keyMetrics.saveRate, color: 'text-pink-500' },
                                { icon: TrendingUp, label: 'Хөрвөх Чадвар (Conversion)', value: analysisResult.keyMetrics.conversionRate, color: 'text-yellow-500' },
                            ].map((metric, index) => (
                        ...
                        <div className="lg:col-span-2 space-y-6 bg-white p-6 rounded-xl shadow-lg border border-gray-100">
                            <h3 className="text-xl font-bold text-indigo-700 border-b pb-2 mb-4">Тархалт & Зорилтот Бүлэг</h3>
                            
                            {/* Platform Reach */}
                            <div className="mb-6">
                                <p className="text-lg font-semibold text-gray-800 mb-3">Платформын Тархалт (%)</p>
                            ...
                            <div>
                                <p className="text-lg font-semibold text-gray-800 mb-3">Насны Бүлгийн Идэвхтэй Оролцоо (%)</p>
                                <div className="space-y-3">
                                    {analysisResult.targetAge.map((item, index) => (
                                        <AnalyticBar 
                                            key={index}
                                            label={`${item.range} нас`}
